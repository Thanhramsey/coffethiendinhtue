...
<section class="lien_he">
    <div class="container">
        <div class="row" style="margin-top:40px">
            <h1 class="text-beauty text-bold text-center" style="color:#fc2a40"> HÌNH ẢNH LỚP HỌC</h1>
            <div class="col-md-12 col-lg-12 col-xs-12 col-12">
                <?php
                        ...
                        foreach ($list as $img) {
                            ...
                            $html .= "<img style='width: 270px;height:350px; border-radius:10px;margin-top:10px'  src='public/images/banners/". $img['img'] ."'>";
                            $html .= "  </a>";
                            $html .= " </div> </div>";
                            echo $html;
                        }
                ...
                <!-- <div class="col-md-4">
                    <div class="fadeInLeft text-center" data-wow-delay="1s" data-wow-duration="3s"
                        ...
                        <img style="width: 350px;height:400px; border-radius:20px;margin-top:10px"
                            src="public/images/banners/<?php echo $img['img'] ?>">
                    </div>
                </div> -->
            </div>
